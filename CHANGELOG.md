...
- **What it does, in full.** The follower walks to within about 75 units of the destination on real pathing, and Harbinger lets go the moment that follower is in combat. The destination is any loaded object in the world, so an enemy is just the common case. A mod can ask for a different distance, between 50 and 512 units.
