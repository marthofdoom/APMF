...
- **What it does, in full.** The follower walks to the destination on real pathing, and Harbinger lets go the moment that follower is in combat. The destination is any loaded object in the world -- an enemy, a chest, a marker, anything -- and the follower stops about 75 units short of it; a mod can ask for a different distance, between 50 and 512 units.
