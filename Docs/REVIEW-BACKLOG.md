...
Raised against `5dcefa7`, same review, SEV-5 items (c) and (d). **The verbatim finding text was not relayed to the author**; the coordinator holds it (reviewer report). To be filled in verbatim before this entry can be drained. Items (a) (INVARIANTS #2 wording) and (e) ("6 conditions") were fixed in the same round.
